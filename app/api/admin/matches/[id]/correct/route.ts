// POST /api/admin/matches/{id}/correct { winner_entry_id, loser_decision? } (rules 12, O-6, spec 5.7, 7.5).
...
export const POST = handle(async (request, { params }) => {
  ...
  const r = await mutateCompetition(session, { competitionId }, (s, ctx) => correctMatch(s, ctx, id, winner, decision));
